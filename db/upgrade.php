...
/**
 * This file keeps track of upgrades to the peerfeedback module
 *
...
/**
 * Execute peerfeedback upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_peerfeedback_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the peerfeedback
     * iself has been upgraded.
     *
     * For each upgrade block, the file peerfeedback/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to peerfeedback.
        ...
        // Define field intro to be added to peerfeedback.
        $table = new xmldb_table('peerfeedback');
        ...
        // Define field introformat to be added to peerfeedback.
        $table = new xmldb_table('peerfeedback');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'peerfeedback');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to peerfeedback.
        $table = new xmldb_table('peerfeedback');
        ...
        // Define field timemodified to be added to peerfeedback.
        $table = new xmldb_table('peerfeedback');
        ...
        // Define index course (not unique) to be added to peerfeedback.
        $table = new xmldb_table('peerfeedback');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'peerfeedback');
    }
